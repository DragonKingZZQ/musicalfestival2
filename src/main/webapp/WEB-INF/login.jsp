...
<div class="container-fluid login_main">
 ...
 <form action="upload/bannerPicture.do" method="post" enctype="multipart/form-data">  
     
     <label>上传头像：</label><input type="file" name="file"><br> 
     <input type="text" id="id" name="id">  
     <input type="submit">  
     </form>  
      <form action="upload/bannerUrl.do" method="post" >  
     ...
     <form action="uploadActor/actorPicture.do" method="post" enctype="multipart/form-data">  
     
      艺人上传：<input type="file" name="file"><br>  
      <!-- <input type="text" id="photo_point_url" name="photo_point_url"> -->  
     <input type="submit">  
     </form> 
     
     <form action="uploadMany/playPicture.do" method="post" enctype="multipart/form-data">  
     
      地图上传：<input type="file" name="file"><br>  
       <input type="text" id="id" name="id" value="1"> id  
     <input type="submit">  
     </form> 
     
      <form action="LinkActor/insertbookhandpdf.do" method="post" enctype="multipart/form-data">  
      
      pdf上传：<input type="text" id="id" name="link_type" value="6"><input type="file" name="file"><br>  
      <!-- <input type="text" id="photo_point_url" name="photo_point_url"> -->  
     <input type="submit">  
     </form> 
  </body>
